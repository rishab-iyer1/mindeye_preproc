...
run("singularity exec --cleanenv --bind {0}:/home "
    "/jukebox/hasson/singularity/heudiconv/heudiconv-v0.12.2.sif "
    "heudiconv -f reproin --subject {2} --ses {3} --bids --locator /home/bids --files "
    "/home/dicom/{1} --overwrite".format(data_dir, subj_dir.split('/')[-1], subj_id, session_id),
    shell=True)
