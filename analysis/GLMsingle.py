...
# bids directory
homedir = '/jukebox/norman/rsiyer/rtmindeye/data_sub-003_ses-01/bids'
# homedir = '/jukebox/norman/rsiyer/rtmindeye/orig_data/bids'
...
# outputdir = join(homedir,'derivatives','glmsingle_half/')
